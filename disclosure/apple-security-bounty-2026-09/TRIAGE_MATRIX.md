...
| EX-006 | IOGPU invalid destroy accepted, client wedge (former candidate 004) | Retracted | High | Do not submit | Controlled 53-case destroy run + harness root-cause | Retracted 2026-09-09: "accepted garbage id" was a live-id collision; "wedge" was a harness self-SIGSEGV on a freed CPU mapping. Destroy validation confirmed strict (journal sections 131/132, run-destroyuaf3.log). |

## Deduplication decisions

- v143 destroy-selector garbage-id acceptance and v144 invalid-destroy wedge were grouped under candidate 004, which is now retracted (EX-006).
